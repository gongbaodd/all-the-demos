...
public final class RenderOperation {
    ...
    public static RenderOperation deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static RenderOperation bincodeDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bincode.BincodeDeserializer(input);
        RenderOperation value = deserialize(deserializer);
    ...
    public boolean equals(Object obj) {
        ...
        RenderOperation other = (RenderOperation) obj;
        return true;
    }
